...
The goal is to help learners connect \*\*myocardial depolarization and repolarization\*\* to the changing voltage measurements seen in a 12-lead EKG. Rather than treating the tracing as an abstract waveform, the app should show what is happening in the heart, how that activity creates body-surface potentials, and why each lead deflects upward, downward, or remains nearly flat during the cardiac cycle.
...
&#x20;   CONCEPTUAL\_MODEL.md

&#x20;   ECG\_LEADS.md

&#x20;   ACTIVATION\_MODEL.md

&#x20;   MECHANICAL\_MODEL.md
...
potential(electrode) ≈ Σ source\_strength × dot(source\_moment, electrode\_position - source\_position) / distance³
